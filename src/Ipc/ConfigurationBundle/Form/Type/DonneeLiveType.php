...
class DonneeLiveType extends AbstractType {

public function buildForm(FormBuilderInterface $builder, array $options) {
	$builder->add('famille','text',array(		'label'         => 'Famille',
												'trim'          => true,
			...
			->add('typeFamille', 'entity', array( 
												'label'   		=> 'Type de la famille',
												'class'         => 'IpcProgBundle:TypeFamilleLive',
												'property'      => 'designation',
												'query_builder' => function(TypeFamilleLiveRepository $tr) {
