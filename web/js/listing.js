...
function trieDonnees(classement) {
	...
	setTimeout(function() {
		...
		htmlListing += "<thead><tr><th class='genre' onClick=\"trieDonnees('genre');\">Genre</th><th class='localisation' onClick=\"trieDonnees('localisation');\">Localisation</th><th class='code' onClick=\"trieDonnees('code');\" >Code message</th><th class='designation' onClick=\"trieDonnees('designation');\">Désignation</th><th class='horodatage' onClick=\"trieDonnees('horodatage');\">Horodatage</th><th class='valeurs' ><span onClick=\"trieDonnees('valeur1');\">Valeur 1</span> / <span onClick=\"trieDonnees('valeur2');\">Valeur 2</span></th></thead>";
		htmlListing += "<tbody>";
		$.each(nouvelle_liste, function(index, donnee) {
			...
			// Si le numéro de la donnée est composé de 3 chiffres on récupère et indiquons le dernier digit
