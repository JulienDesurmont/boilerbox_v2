...
php ${chemin_console_php} fos:user:create AdminLTS AdminLts@lci-group.fr 'admlts59'
php ${chemin_console_php} fos:user:promote AdminLTS ROLE_ADMIN_LTS
...
php ${chemin_console_php} fos:user:create TechnicienLTS technicienLTS@lci-group.fr '5667tech'
php ${chemin_console_php} fos:user:promote TechnicienLTS ROLE_TECHNICIEN_LTS
